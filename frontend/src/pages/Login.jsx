  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10 px-4 sm:px-0">
        <div className="backdrop-blur-md bg-white/60 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 py-8 px-6 shadow-2xl rounded-2xl sm:px-10 transition-colors duration-300">
            ...
            <div>
              ...
              <div className="mt-1.5 relative rounded-lg shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-4 py-2.5 bg-white/50 dark:bg-slate-950/50 border border-slate-300 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-brand-green/45 focus:border-brand-green transition-all"
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-transparent px-2 text-slate-500">Demo Environment</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full inline-flex justify-center py-2.5 px-4 border border-slate-300 dark:border-slate-800 rounded-xl bg-slate-50/50 dark:bg-slate-950/30 text-xs font-semibold text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-900 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-300 dark:focus:ring-slate-700"
              >
